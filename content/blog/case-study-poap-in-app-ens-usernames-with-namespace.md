---
title: "[Case Study] POAP: In-app ENS Usernames with Namespace"
slug: case-study-poap-in-app-ens-usernames-with-namespace
...
[POAP](https://poap.xyz/) already had real distribution, a clear product, and a strong brand. The goal was not to fix something broken. It was to upgrade a working experience by migrating from a previous subname infrastructure provider to Namespace, without downtime, without user friction, and without introducing operational risk.
...
- **Names used:** `onpoap.eth`, `poap.xyz`, and `withpoap.eth`
- **Outcome:** 5,000+ subnames issued, smooth migration, no downtime, and no reported issues post-migration
...
- supporting issuance across `onpoap.eth`, `poap.xyz`, and `withpoap.eth`
- helping ensure the migration happened cleanly and on time
...
- Launch directly with Namespace: [app.namespace.ninja](https://app.namespace.ninja/)
- Build with the API and docs: [docs.namespace.ninja](https://docs.namespace.ninja/)
- Talk to the team: [namespace.ninja](https://namespace.ninja/)
- Learn more about POAP: [poap.xyz](https://poap.xyz/)
